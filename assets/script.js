...
//Comment form sending ccmment via Whatsapp
document.getElementById('sendMessage').addEventListener('click', function() {
    ...
    const whatsappMessage = encodeURIComponent(`*${subject}* from ${fullName} (${phone}):\n\n${message}`);

    // Create WhatsApp URL
    const whatsappUrl = `https://wa.me/254707657191?text=${whatsappMessage}`; // Directing to the specified number
